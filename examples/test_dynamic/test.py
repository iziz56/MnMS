...
roads.register_section('1b_6b',  '1b',  '6b', 300)
roads.register_section('6b_1b',  '6b',  '1b', 300)
roads.register_section('6b_11b', '6b', '11b', 300)
roads.register_section('11b_6b', '11b', '6b', 300)
roads.register_section('11b_16b','11b', '16b', 300)
roads.register_section('16b_11b','16b', '11b', 300)
roads.register_section('16b_21b','16b', '21b', 300)
roads.register_section('21b_16b','21b', '16b', 300)

roads.register_section('3b_8b',  '3b',  '8b', 300)
roads.register_section('8b_3b',  '8b',  '3b', 300)
roads.register_section('8b_13b', '8b', '13b', 300)
roads.register_section('13b_8b', '13b', '8b', 300)
roads.register_section('13b_18b','13b', '18b', 300)
roads.register_section('18b_13b','18b', '13b', 300)

roads.register_section('5b_6b',  '5b',  '6b', 300)
roads.register_section('6b_5b',  '6b',  '5b', 300)
roads.register_section('6b_7b',  '6b',  '7b', 300)
roads.register_section('7b_6b',  '7b',  '6b', 300)
roads.register_section('7b_8b',  '7b',  '8b', 300)
roads.register_section('8b_7b',  '8b',  '7b', 300)
roads.register_section('8b_9b',  '8b',  '9b', 300)
roads.register_section('9b_8b',  '9b',  '8b', 300)


roads.register_section('15b_16b','15b', '16b', 300)
roads.register_section('16b_15b','16b', '15b', 300)
roads.register_section('16b_17b','16b', '17b', 300)
roads.register_section('17b_16b','17b', '16b', 300)
roads.register_section('17b_18b','17b', '18b', 300)
roads.register_section('18b_17b','18b', '17b', 300)
roads.register_section('18b_19b','18b', '19b', 300)
roads.register_section('19b_18b','19b', '18b', 300)
...
#1. bus line 1b_21b
roads.register_stop('S1b',   '1b_6b', 0.00)
roads.register_stop('S6b',   '1b_6b', 1.00)
roads.register_stop('S6b',   '6b_11b', 0.00)
roads.register_stop('S11b',  '6b_11b', 1.00)
roads.register_stop('S11b',  '11b_16b', 0.00)
roads.register_stop('S16b',  '11b_16b', 1.00)
roads.register_stop('S16b',  '16b_21b', 0.00)
roads.register_stop('S21b',  '16b_21b', 1.00)


# #2 bus line 21b_1b
# roads.register_stop('Sr21b', '21b_16b', 0.00)
# roads.register_stop('Sr16b', '21b_16b', 1.00)
# roads.register_stop('Sr16b', '16b_11b', 0.00)
# roads.register_stop('Sr11b', '16b_11b', 1.00)
# roads.register_stop('Sr11b', '11b_6b', 0.00)
# roads.register_stop('Sr6b',  '11b_6b', 1.00)
...
banning_section = ['1b_6b',  '6b_11b', '11b_16b', '16b_21b', '21b_16b', '16b_11b', '11b_6b', '6b_1b',
                   '3b_8b',  '8b_13b', '13b_18b', '18b_19b', '19b_18b', '18b_13b', '13b_8b', '8b_3b',
                   '5b_6b',   '6b_7b',   '7b_8b',   '8b_9b',   '9b_8b',   '8b_7b',  '7b_6b',  '6b_5b',
                  '15b_16b','16b_17b', '17b_18b', '18b_19b', '19b_18b', '18b_17b', '17b_16b','16b_15b',
                     '1_1b',   '1b_1',   '3_3b',   '3b_3',   '5_5b',   '5b_5',    '6_6b',    '6b_6',
                     '7_7b',   '7b_7',   '8_8b',   '8b_8',   '9_9b',   '9b_9',  '11_11b',  '11b_11',
                   '13_13b',  '13b_13','15_15b', '15b_15', '16_16b', '16b_16',  '17_17b',  '17b_17',  
                   '18_18b',  '18b_18','19_19b', '19b_19', '21_21b', '21b_21',  '23_23b', '23b_23']

banning_nodes = ['1b', '3b', '21b', '23b', '5b', '9b', '15b', '19b', '6b', '7b', '8b', '11b', '13b', '16b', '17b', '18b']
                     
roads.add_zone(construct_zone_from_sections(roads, "Res_bus", banning_section))

# time_slots = [Time("06:59:59"), Time("07:09:50"), Time("07:19:50"), Time("07:29:50"), Time("07:39:50")] # before one simulation step
time_slots = [Time("07:00:00"), Time("07:15:00"), Time("07:30:00"),Time("07:45:00"),Time("08:00:00")] # before one simulation step
...
car_layer = generate_layer_from_roads(roads, 'CAR', mobility_services=[personal_car], banned_nodes = banning_nodes,
                                     banned_sections=banning_section)
...
bus_layer.create_line("L1" ,["S1b","S6b","S11b","S16b","S21b"],      [["1b_6b"],["6b_11b"],["11b_16b"],["16b_21b"]],
                        timetable=TimeTable.create_table_freq('07:00:00', '09:00:00', Dt(minutes=5)))   
# bus_layer.create_line("Lr1",["Sr21b","Sr16b","Sr11b","Sr6b","Sr1b"], [["21b_1b"],["21b_1b"],["21b_1b"],["21b_1b"]],
#                         timetable=TimeTable.create_table_freq('07:00:00', '09:00:00', Dt(minutes=5)))

# bus_layer.create_line("L2" ,["S3b","S8b","S13b","S18b","S23b"],[["3b_23b"],["3b_23b"],["3b_23b"],["3b_23b"]],
#                         timetable=TimeTable.create_table_freq('07:00:00', '09:00:00', Dt(minutes=5)))                        
# bus_layer.create_line("Lr2",["Sr23b","Sr18b","Sr13b","Sr8b","Sr3b"],[["23b_3b"],["23b_3b"],["23b_3b"],["23b_3b"]],
#                         timetable=TimeTable.create_table_freq('07:00:00', '09:00:00', Dt(minutes=5)))

# bus_layer.create_line("L3" ,["S5b","S6b","S7b","S8b","S9b"],[["5b_9b"],["5b_9b"],["5b_9b"],["5b_9b"]],
#                         timetable=TimeTable.create_table_freq('07:00:00', '09:00:00', Dt(minutes=5)))                        
# bus_layer.create_line("Lr3",["Sr9b","Sr8b","Sr7b","Sr6b","Sr5b"],[["9b_5b"],["9b_5b"],["9b_5b"],["9b_5b"]],
#                         timetable=TimeTable.create_table_freq('07:00:00', '09:00:00', Dt(minutes=5)))

# bus_layer.create_line("L4" ,["S15b","S16b","S17b","S18b","S19b"],[["15b_19b"],["15b_19b"],["15b_19b"],["15b_19b"]],
#                         timetable=TimeTable.create_table_freq('07:00:00', '09:00:00', Dt(minutes=5)))                        
# bus_layer.create_line("Lr4",["Sr19b","Sr18b","Sr17b","Sr16b","Sr15b"],[["19b_15b"],["19b_15b"],["19b_15b"],["19b_15b"]],
#                         timetable=TimeTable.create_table_freq('07:00:00', '09:00:00', Dt(minutes=5)))
...
demand = BaseDemandManager([                            
                            User("U0",  [0, 1200], [1200, 0], Time("07:00:00"),['UBER']),
                            User("U1",  [0, 1200], [1200, 0], Time("07:01:00"),['UBER']),
                            User("U2",  [0, 1200], [1200, 0], Time("07:02:00"),['UBER']),
                            User("U3",  [0, 1200], [1200, 0], Time("07:03:00"),['UBER']),
                            User("U4",  [0, 1200], [1200, 0], Time("07:04:00"),['UBER']),
                            User("U5",  [0, 1200], [1200, 0], Time("07:05:00"),['UBER']),
                            User("U6",  [0, 1200], [1200, 0], Time("07:06:00"),['UBER']),
                            User("U7",  [0, 1200], [1200, 0], Time("07:07:00"),['UBER']),
                            User("U8",  [0, 1200], [1200, 0], Time("07:08:00"),['UBER']),
                            User("U9",  [0, 1200], [1200, 0], Time("07:09:00"),['UBER']),
                            User("U10", [0, 1200], [1200, 0], Time("07:10:00"),['UBER']),
                            User("U11", [0, 1200], [1200, 0], Time("07:11:00"),['UBER']),
                            User("U12", [0, 1200], [1200, 0], Time("07:12:00"),['UBER']),
                            User("U13", [0, 1200], [1200, 0], Time("07:13:00"),['UBER']),
                            User("U14", [0, 1200], [1200, 0], Time("07:14:00"),['UBER']),
                            User("U15", [0, 1200], [1200, 0], Time("07:15:00"),['UBER']),
                            User("U16", [0, 1200], [1200, 0], Time("07:16:00"),['UBER']),
                            User("U17", [0, 1200], [1200, 0], Time("07:17:00"),['UBER']),
                            User("U18", [0, 1200], [1200, 0], Time("07:18:00"),['UBER']),
                            User("U19", [0, 1200], [1200, 0], Time("07:19:00"),['UBER']),
                            User("U20", [0, 1200], [1200, 0], Time("07:20:00"),['UBER']),
                            ])
